      ...
      <?php endif; ?>
		...
		<div id="nav">
			...
			<ul>
				...
				<li class="nav-catalog"><a href="http://mymcpl.org/catalog">Catalog</a></li>
...
<!-- div class="footer"><a href="http://opac.mcpl.lib.mo.us/uhtbin/cgisirsi/x/0/0/57/1/1225/X/BLASTOFF?user_id=WEBSERVER" target="_catalog" class="more view-all">View All</a></div --><!-- /.footer -->
		...
		<div id="tertiary">
			<div class="inner">
				...
				<?php/* 
					$promo =views_embed_view('Promotions', 'block_4');  
					$match1 = '<span class="field-content" >';
					$replace1 = '';
					$promo   = str_replace($match1, $replace1,  $promo );
					$match1 = '</span>';
    ...
    <tr>
      <td style="padding-top:6px;">
        ...
        <form action="http://library.booksite.com/7120/signupSubscribe/?list=NLSGN" method="post" style="padding-top:6px;">
          ...
          <input name="email" size="25" style="padding-left:6px;border: 1px solid #999 !important" title="Input your email address" /> 
