...
<head>
  ...
  <?php print $scripts; ?>
<?php if ($node_type == "event" || $node->nid == 11) { ?>
		<link type="text/css" href="/sites/all/themes/mcpl/_resources/css/flick/jquery-ui-1.8.4.custom.css" rel="stylesheet" />	
		<script type="text/javascript" src="/sites/all/themes/mcpl/_resources/js/jquery-1.4.1.min.js"></script>
		<script type="text/javascript" src="/sites/all/themes/mcpl/_resources/js/jquery-ui-1.8.4.custom.min.js"></script>
		

<?php } ?>
<meta name="google-translate-customization" content="f4efea754281a09d-916c9849e0739d4c-g31a63de1868f42e3-e"></meta><!-- Testing Google translate - AMW 5-27-14 -->
</head>
