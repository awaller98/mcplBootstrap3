...
<head>
 ...
 <meta name="apple-itunes-app" content="app-id=507169738">
  <meta name="google-play-app" content="app-id=com.bredir.boopsie.mymcpl"> 
  <!--<meta name="amazon-app" content="app-id=com.bredir.boopsie.mymcpl"> -->
  <?php print $head; ?>
  <?php print $styles; ?>
 <link rel="stylesheet" href="sites/all/themes/mcpl/_resources/js/smart-app-banner-master/smartbanner.css" type="text/css" media="screen"> 
  <link rel="android-touch-icon" href="sites/all/themes/mcpl/_resources/js/smart-app-banner-master/android-icon.png" />
  <?php print $scripts; ?>
...
// select #flowplanes and make it scrollable. use circular and navigator plugins
	$j("#flowpanes").scrollable({ circular: true, mousewheel: true }).autoscroll({autoplay: true,interval: 5000,steps: 1}).navigator({
			...
			<div id="content-inner">
				<div id="lead">
					...
					<div id="slider-container">
						...
						<ul id="flowtabs" class="navi show">
...
<table border="0" cellpadding="3" cellspacing="0" width="208">
  <tbody>
    <tr>
      <td style="padding-top:6px;">

        <p><img align="left" alt="" border="0" hspace="4" 
                src="http://belldandy.booksite.com/blimages/ckupload/img0X3HJ0mailbox.jpg" width="50" />
           Subscribe to the Library Newsletter.</p>

        <div text-align="left">
        <form action="http://library.booksite.com/7120/signupSubscribe/?list=NLSGN" method="post" style="padding-top:6px;">
          <input name="list[]" type="hidden" value="AU5" />
          <input name="email" size="35" style="padding-left:6px;border: 1px solid #999 !important" title="Input your email address" /> 
          <input name="sid" type="hidden" value="7120" /> 
          <input style="border:1px solid white !important; margin-top:6px;" src="http://belldandy.booksite.com/blimages/ckupload/imgTdwbd7subscribe.gif" type="image" />
        </form>
        </div>
...
<p>&nbsp;</p>
				...
				<div class="block block-events">
					...
					<div class="content"> 	
						...
						<!-- <ul class="events"> -->
                    <?php 
                       $event_list = date_embed_view('calendar_prod', 'block_1'); 
                       print $event_list; ?>
				...
				<div class="cta-newsletter">
					<a href="/books-movies-music/reading-suggestions">Get Reading Suggestions</a>
				</div><!-- /.cta-newsletter -->
...
<!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js"></script> -->
        <script src="sites/all/themes/mcpl/_resources/js/smart-app-banner-master/smartbanner.js"></script>
       <script type="text/javascript">
      new SmartBanner({
          daysHidden: 15,   // days to hide banner after close button is clicked (defaults to 15)
          daysReminder: 1, // days to hide banner after "VIEW" button is clicked (defaults to 90)
          appStoreLanguage: 'us', // language code for the App Store (defaults to us)
          title: 'Mid-Continent Public Library - Mobile',
          author: 'Boopsie',
          button: 'VIEW',
         store: {
           ...
           , force: 'kindle' // Uncomment for platform emulation
      });
    </script>
</body>
</html>
